...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 569.0, 80.0, 22.0 ],
					"text" : "speedlim 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 672.0, 597.0, 48.0, 22.0 ],
					"text" : "del 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 934.5, 585.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 815.0, 624.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.5, 466.0, 79.0, 22.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 672.0, 487.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1022.0, 580.0, 234.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 964.0, 618.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 202.5, 47.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 815.0, 700.0, 40.0, 22.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 815.0, 661.0, 29.5, 22.0 ],
					"text" : "/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 815.0, 729.0, 202.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 186.5, 265.0, 10.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 914.0, 673.0, 184.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 881.0, 372.0, 83.0, 22.0 ],
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 815.0, 585.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 881.0, 444.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.5, 159.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 856.399999999999977, 507.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 815.0, 487.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.5, 158.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 672.0, 372.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 980.600000000000023, 88.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "clear", "" ],
					"patching_rect" : [ 815.0, 549.0, 226.0, 22.0 ],
					"text" : "bp_validation"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.5, 110.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.5, 80.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.5, 1.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.5, 130.0, 199.5, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 11.5, 67.0, 261.0, 83.0 ],
					"types" : "WAVE"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 213.5, 33.5, 59.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 11.5, 33.5, 188.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 5.5, 276.0, 225.5 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 979.75, 575.5, 973.5, 575.5 ],
					"source" : [ "obj-103", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 928.0, 616.0, 923.5, 616.0 ],
					"source" : [ "obj-103", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 876.25, 581.0, 850.375, 581.0, 850.375, 476.0, 824.5, 476.0 ],
					"order" : 1,
					"source" : [ "obj-103", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 876.25, 577.5, 944.0, 577.5 ],
					"order" : 0,
					"source" : [ "obj-103", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 890.5, 507.0, 907.299999999999955, 507.0 ],
					"order" : 0,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 890.5, 651.0, 835.0, 651.0 ],
					"order" : 1,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1014.0, 655.0, 1135.25, 655.0, 1135.25, 538.0, 1031.5, 538.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 84.666666666666686, 419.5, 948.700000000000045, 419.5 ],
					"order" : 0,
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 824.5, 521.0, 753.0, 521.0, 753.0, 476.0, 681.5, 476.0 ],
					"order" : 1,
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 681.5, 635.0, 494.5, 635.0, 494.5, 57.0, 250.5, 57.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 127.0, 498.75, 84.5, 498.75 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 944.0, 612.0, 973.5, 612.0 ],
					"source" : [ "obj-54", 0 ]
				}
